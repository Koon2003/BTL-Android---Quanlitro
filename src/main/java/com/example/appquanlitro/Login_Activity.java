...
public class Login_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dangki.setOnClickListener(view -> {
            Intent intent = new Intent(getApplicationContext(), DangKi_TaiKhoan_NguoiDung_Activity.class);
    ...
    private void startAutoLogoutTimer() {
        ...
        timeoutRunnable = new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(Login_Activity.this, TrangChu_NguoiDung_Activity.class);
