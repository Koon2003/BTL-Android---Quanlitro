...
public class DangKi_TaiKhoan_NguoiDung_Activity extends AppCompatActivity {


    EditText tendn, matkhau, hovaten, cccd, quequan, ngaysinh, sdt, nhaplaimatkhau;
    TextView Quyen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dangki_taikhoan_nguoidung);

        tendn = findViewById(R.id.tendn);
        matkhau = findViewById(R.id.mk);
        nhaplaimatkhau = findViewById(R.id.nhaplaimk);
        ...
        Quyen = findViewById(R.id.quyen); // Nút để chọn quyền
...
// Trong phương thức onCreate, thêm đoạn mã sau:
        ...
        btnHuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DangKi_TaiKhoan_NguoiDung_Activity.this, Login_Activity.class);
    ...
    private void saveTaiKhoan() {
        ...
        String quyenValue = "Khách hàng"; // Quyền mặc định
        // Kiểm tra dữ liệu hợp lệ
        if (tendnValue.isEmpty() || matkhauValue.isEmpty() || nhapLaiMatKhauValue.isEmpty() ||
                hovatenValue.isEmpty() || quequanValue.isEmpty() ) {
