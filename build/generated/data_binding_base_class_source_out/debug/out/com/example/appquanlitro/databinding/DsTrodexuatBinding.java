...
public final class DsTrodexuatBinding implements ViewBinding {
  @NonNull
  ...
  private DsTrodexuatBinding(@NonNull RelativeLayout rootView, @NonNull CardView bi,
  ...
  @NonNull
  public static DsTrodexuatBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DsTrodexuatBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ds_trodexuat, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DsTrodexuatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DsTrodexuatBinding((RelativeLayout) rootView, bi, bo, dientich, giatien, hi, id_,
