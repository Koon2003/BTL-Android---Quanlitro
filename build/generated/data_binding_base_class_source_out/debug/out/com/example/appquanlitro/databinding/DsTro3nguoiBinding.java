...
public final class DsTro3nguoiBinding implements ViewBinding {
  @NonNull
  ...
  private DsTro3nguoiBinding(@NonNull RelativeLayout rootView, @NonNull CardView bi,
  ...
  @NonNull
  public static DsTro3nguoiBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DsTro3nguoiBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ds_tro3nguoi, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DsTro3nguoiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DsTro3nguoiBinding((RelativeLayout) rootView, bi, bo, dientich, giatien, hi, id_,
